...
outputCSV.write('\t'. join(['chr', 'pos', 'Ref', 'Alt', 'Normal GT', 'Normal AF', 'Normal Alt Depth', ' Normal Ref Depth', 'Tumor GT', 'Tumor AF', 'Tumor Alt depth', ' Tumor Ref depth', 'Variant function', 'Variant Exonic function', 'Variant Gene', ' AA/CDS change', '1000g2012apr_all', 'snp129Flag', 'snp137Flag', 'cosmic38Flag', 'LJB23_SIFT_score', 'LJB23_SIFT_pred', 'LJB23_Polyphen2_HDIV_score', 'LJB23_Polyphen2_HDIV_pred, ''LJB23_Polyphen2_HVAR_score', 'LJB23_Polyphen2_HVAR_pred', 'LJB23_GERP++', 'LJB23_PhyloP', 'LJB23_SiPhy']) + '\n')
