...
if __name__ == "__main__":
	...
	total_eligible_bases = options.bases[0]
	total_possible_bases = options.bases[1]
	...
	try:
		change_counts['error_rate'] = (float(error_count) / total_eligible_bases)
	except ZeroDivisionError:
		change_counts['error_rate'] = 0
	change_counts['total_eligible_bases'] = total_eligible_bases
	change_counts['perc_avail_bases'] = total_eligible_bases / total_possible_bases
