...
#Picard was used to mark duplicates, clean-up ealier version so that we can re-start jobs with BamDuplicates 
# first test D0009_Run2 : BamDuplicates vs Picard 
