...
#The exact same as integerarray.py, but instead of returning a count of genes in that cell it returns a list of genes
#in that cell. Need to use this array for comparearrays.py
